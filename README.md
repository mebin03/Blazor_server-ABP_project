...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f43fa193-46c4-4e5f-924b-95338b1871c2
```

> `f43fa193-46c4-4e5f-924b-95338b1871c2` is the password of the certificate, you can change it to any password you want.
